...
-- =============================================================================
-- Debugging
vim.keymap.set({ "n" }, "<Leader>db", cmd("DapToggleBreakpoint"), { silent = true, desc = "Add breakpoint at line" })
vim.keymap.set({ "n" }, "<Leader>dus", function()
	local widgets = require("dap.ui.widgets")
	local sidebar = widgets.sidebar(widgets.scope)
	sidebar.open()
end, { silent = true, desc = "Open debugging sidebar" })

vim.keymap.set({ "n" }, "<Leader>dgt", function()
	require("dap-go").debug_test()
end, { silent = true, desc = "Debug go test" })

vim.keymap.set({ "n" }, "<Leader>dgl", function()
	require("dap-go").debug_last()
end, { silent = true, desc = "Debug last go test" })
...
vim.keymap.set(
	...
	{ silent = true, desc = "Find [d]ocument [s]ymbol" }
)

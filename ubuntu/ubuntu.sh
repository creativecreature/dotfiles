...
if exists "node"; then
  ...
  if get_boolean_response "Do you want to install Node.js tools?"; then
    ...
    nvm install 12.2.0
    npm install -g eslint@5.16 eslint-config-prettier@6.0.0 eslint-config-standard@12.0.0 eslint-plugin-import@2.18.0 eslint-plugin-jest@22.7.2 eslint-plugin-node@9.10 eslint-plugin-promise@4.2.1 eslint-plugin-standard@4.0.0 eslint-plugin-react babel-eslint yarn neovim
  else
